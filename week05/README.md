...
- **Lecture support:** [C examples](lectures/examples.c) ·
  [Python contrast companion](lectures/week05_python_companion.md) ·
  [Exercises and starter](lectures/lecture_exercises/week05_ex.md)
...
Project milestone: trace token-list construction and conversion, then design
boundary and invalid-input tests without implementing the graded parser TODOs.
