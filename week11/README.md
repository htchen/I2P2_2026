...
- **Lecture support:** [C++ examples](lectures/examples.cpp) · [Exercises and starter](lectures/lecture_exercises/week11_ex.md)
...
Assessment milestone: complete AI-free template, boundary-algorithm, and
container-invalidation practice before these topics enter the Midterm 2 scope.
