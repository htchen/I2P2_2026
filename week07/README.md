...
ownership, semantic checks, code-generation traversal, and the distinction
between native assembly and the project's simulated target.

Project milestone: plan and verify the parser, semantic checks, and target
instruction generation in stages before the Week 10 demo; optimization remains
optional until correctness and memory safety are established.
