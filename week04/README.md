...
- **Lecture support:** [C examples](lectures/examples.c) · [Exercises and starter](lectures/lecture_exercises/week04_ex.md)
...
Project milestone: identify every allocation owner and cleanup path in the
compiler scaffold, then diagnose a seeded memory error with sanitizers.
