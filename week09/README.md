...
Final-project work: apply the Week 8 RAII foundation and the Week 9 class model
by tracing one input event through update and draw and one Allegro resource
through normal initialization, failure, and cleanup.
